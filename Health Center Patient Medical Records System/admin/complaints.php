...
<body>
	...
	<div id = "content">
		...
		<div style = "display:none;" id = "com" class = "panel panel-success">	
			...
			<?php
				$conn = new mysqli("localhost", "root", "", "hcpms") or die(mysqli_error()); //retrieves selected patient to be added of complaints and diagnosis
			...
			?>
				<form method = "POST" enctype = "multipart/form-data">
					...
					<div class = "form-inline">
						...
						<input class = "form-control" name = "age" value = "<?php echo $f['age']?>" disabled = "disabled" type = "text" required = "required">
						&nbsp;&nbsp;&nbsp;
						<label for = "lastname">Gender</label>
						<input class = "form-control" name = "gender" value = "<?php echo $f['gender']?>" disabled = "disabled" type = "text" required = "required">
		...
		<div class = "panel-body">
			<?php
				$q1 = $conn->query("SELECT * FROM `itr` WHERE `itr_no` = '$_GET[id]'") or die(mysqli_error()); //displays complaints
				$f1 = $q1->fetch_array();
