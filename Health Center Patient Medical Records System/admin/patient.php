	...
	<div id = "content">
		...
		<div style = "display:none;" id = "add_itr" class = "panel panel-success">	
			<div class = "panel-heading">
				<label>ADD PATIENT INFORMATION</label> <!-- add new patient and details -->
		...
		<div class = "panel panel-primary">
			<div class = "panel-heading">
				<label>PATIENTS LIST</Label> <!-- displays all patients -->
			</div>
			<div class = "panel-body">
				...
				<table id = "table" class = "display" width = "100%" cellspacing = "0">
					...
					<?php 
						$conn = new mysqli("localhost", "root", "", "hcpms") or die(mysqli_error()); 
						$query = $conn->query("SELECT * FROM `itr` ORDER BY `itr_no` DESC") or die(mysqli_error()); // retrieves patients from database
