...
<body>
	...
	<div id = "sidebar">
			<ul id = "menu" class = "nav menu">
				<li><a href = ""><i class = "glyphicon glyphicon-home"></i> Accounts</a>
					<ul>
	...
	<div id = "content">
		...
		<?php
			$conn = new mysqli("localhost", "root", "", "hcpms") or die(mysqli_error());
			$query = $conn->query("SELECT * FROM `admin` WHERE `admin_id` = '$_GET[id]'") or die(mysqli_error()); //retrieves the selected account to update
			$fetch = $query->fetch_array();
		?>
			<div class = "panel-heading">
				<label>EDIT ADMINISTRATOR</label> <!-- update admin acc -->
